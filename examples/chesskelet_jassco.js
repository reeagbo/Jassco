...
function userInput(key) {
  ...
  function search() {                                                      // Chess program
    ...
    attacks.fill(0);                                      					// Clear white attack map
          ...
          while (vector_offset) {                                          // Loop over vector offsets
            ...
            while (1) {                                                    // Loop over squares along the given vector offset
              ...
              if (spiece & 0x02) {                                          // If piece is black
				...
				number_of_moves++
				console.log ("Move #", number_of_moves, ": ", source_sq, ", ", target_sq)
    ...
    for (let i = 0; i < number_of_moves; i++) {                           // Loop over moves in a move list
	  ...
	  console.log (move_list[i][0], " ", move_list[i][1], " ", valuation)
      if (valuation > best_score) {                                        // Found better move?
        best_score = valuation;                                            // Update best score
        best_move[0] = move_list[i][0];                                          // Save best move
		best_move[1] = move_list[i][1];
      }
    }
