...
fn_parseSquare_char_file_   defw 0                ; (FunctionDeclaration) literal int/bool
fn_parseSquare_char_rank_   defw 0                ; (FunctionDeclaration) literal int/bool
...
fn_userInput_key_   defw 0                ; (FunctionDeclaration) literal int/bool
...
parseSquare_                        ; (FunctionDeclaration) *** parseSquare_ ***
        ...
        ld hl, fn_parseSquare_char_file_            ; argument *** fn_parseSquare_char_file_ ***
        pop de                  ; <<< pop address
        pop bc                  ; <<< pop value
        ...
        ld hl, fn_parseSquare_char_rank_            ; argument *** fn_parseSquare_char_rank_ ***
        pop de                  ; <<< pop address
        pop bc                  ; <<< pop value
        ld (hl), e              ; store it in memory
        inc hl                  ;
        ...
        push hl                 ; >>> push variable content
                                ...
                                ; (Identifier) variable * fn_parseSquare_char_file_ *
        ld hl, fn_parseSquare_char_file_            ; variable address
        push hl                 ; >>> push variable address
        ld hl, (fn_parseSquare_char_file_)          ; variable content
        push hl                 ; >>> push variable content
        ...
        push de                 ; >>> push value
                                ...
                                ; (Identifier) variable * fn_parseSquare_char_rank_ *
        ld hl, fn_parseSquare_char_rank_            ; variable address
        push hl                 ; >>> push variable address
        ld hl, (fn_parseSquare_char_rank_)          ; variable content
        push hl                 ; >>> push variable content
...
userInput_                        ; (FunctionDeclaration) *** userInput_ ***
        ...
        inc (hl)                ; end of return address preps
                                ...
                                ; (FunctionDeclaration) collect arguments
        ld hl, fn_userInput_key_            ; argument *** fn_userInput_key_ ***
        pop de                  ; <<< pop address
        pop bc                  ; <<< pop value
        ld (hl), e              ; store it in memory
        inc hl                  ;
        ld (hl), d              ;
                                ...
                                ; (Identifier) variable * fn_userInput_key_ *
        ld hl, fn_userInput_key_            ; variable address
        push hl                 ; >>> push variable address
        ld hl, (fn_userInput_key_)          ; variable content
        push hl                 ; >>> push variable content
