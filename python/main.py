...
def main(input_file, output_file):
    ...
    # assembly code build -------------------------------------------------------
    # compiler info
    full_code.append(f"; Generated with ASsembly COmpiler, JASCO v0. Boria Labs 2025.")
    
    # directives ------------------------------------------------------------------------------
    full_code.append("; Directives -------------------------------------------------")
    full_code.append(f"        str_max equ {string_max_length}          ; maximum string length")
    full_code.append(f"        org {initial_address}               ; initial code address\n")
    full_code.append(f"sta_cod jp mai_cod              ; jumps to main code")
    
    # variable declarations -------------------------------------------------------------------
    full_code.append("\n; Variable declarations --------------------------------------")
    # auxiliary stack
    full_code.append(f'        sta_ck2 defw 24500      ; auxiliary stack address') 
