    ...
    def process_node(node):
        ...
        match node.type:          
                            ...
                            case "==" | "!=" | "<" | ">" |"<=" | ">=":
                                ...
                                match operator_name:
                                    ...
                                    case ">":
                                        ...
                                        nodes_code.append(f"        xor a                   ;")
                                        nodes_code.append(f"        sbc hl, bc              ;")
                                        nodes_code.append(f"        jp c, {equ_label}           ; if <, false -> change")
            ...
            case "ForStatement":
                ...
                #break_label_stack.append(exit_label)
                ...
                # recover outer label after processing body
                #exit_label = break_label_stack.pop()
            ...
            case "IfStatement":
                ...
                nodes_code.append(f"        jp {end_label}              ; ({node.type}) skips else")
            ...
            case "Literal":
                ...
                # integer literal
                # pending: simplify: ld hl + push + push, no garbage zone
            ...
            case "SwitchStatement":
                #print (f"({node.type}) Node:\n {node}")
                #switch_break_label = new_label("bre_")
            ...
            case "WhileStatement": # contains one or more variable declaration
                ...
                if node.test:
                    ...
                    nodes_code.append(f"        jp z, {break_label_stack[-1]}           ; exit loop\n")
                ...
                ### need to pop current tag and go to previous tag. good for all situations?
                #exit_label = break_label_stack.pop()
                    
                #print (f"({node.type}) Stack content: {break_label_stack}\n")
                
                # node exit
                nodes_code.append(f"        jp {while_label}              ; ({node.type})")                
